...
<html>
<head>
	<title>Peminjaman Inventarisasi Seni</title>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-8">
						...
						<p class="text-muted">Peminjaman Inventarisasi Seni adalah aplikasi berbasis web yang dibuat dengan tujuan untuk mempermudah penanganan di bidang sarana & prasarana. Serta menyesuaikan diri dengan semakin majunya Teknologi Informasi</p>
		...
		<div class="navbar navbar-dark bg-dark shadow-sm">
			<div class="container">
				<a class="navbar-brand align-items-center" style="color:#fff;">
					<strong> Peminjaman Inventarisasi Seni</strong>
				</a>
